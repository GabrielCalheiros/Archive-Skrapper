...
if __name__ == "__main__":
    ...
    # item = internetarchive.get_item('Ms.Codex0708_27')
    # for k, v in item.metadata.items():
    #     print(f"{k}:{v}")
    # input("Press Enter to continue...")
    ...
    querries = [
        f'subject:architecture mediatype:texts date:2016',
        f'subject:architecture mediatype:texts date:2016',
...
# f'subject:architecture mediatype:texts date:1140',
    ...
    for querry in querries:
        ...
        file_path = f"C:\\Users\\gabriel.miranda\\Desktop\\Projetos\\Personal Github\\collection_downloaded\\{querry_name}_{start_index}_{end_index}.xlsx"
